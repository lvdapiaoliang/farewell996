 ...
 * @author 吕国鹏
 * @version 1.0
 * @description: 全新的 MyBatis-Plus 代码生成器，
 * 通过 builder 模式可以快速生成你想要的代码，快速且优雅，
 * 跟随下面的代码一睹为快。
...
public class MybatisPlusGenerator {
  ...
  public static void main(String[] args) {
    String dbUrl =
        "jdbc:mysql://localhost:3306/farewell996?useUnicode=true&characterEncoding=UTF-8"
            + "&allowMultiQueries=true";
    String dbUser = "root";
    String dbPassword = "Xx@125313";
    String author = "吕国鹏";
    String parentPackageName = "com.lvdapiaoliang";
    // 需要生成的表名。支持多个。 List<String> tables = Arrays.asList("employees", "user");
    List<String> tables = Arrays.asList("work_order_answer_easy_ask", "work_order_answer_file_easy_ask");
    List<String> tablePrefix = Arrays.asList("SYS_", "XXL_");

    String PROJECT_ROOT_PATH =
        "D:\\0-software\\2-Java\\2-idea\\1-code\\0-Learning\\farewell996\\mybatisplus_generator";
    String BASE_PATH = PROJECT_ROOT_PATH + "/src/main/java/com/lvdapiaoliang";
    // 六个文件的路径
    ...
    fastAutoGenerator.globalConfig(builder -> builder
        ...
        .strategyConfig((scanner, builder) -> builder
            ...
            // 开启链式模型。
            // 会在实体类前添加 [@Accessors(chain = true)] 注解。用法如 [User user=new User().setAge(31)
            // .setName("snzl");]（这是Lombok的注解，需要添加Lombok依赖）
            .enableChainModel()
            // 开启 lombok 模型。
