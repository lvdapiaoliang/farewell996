...
import com.lvdapiaoliang.trade.domain.OrderState;
...
import com.lvdapiaoliang.trade.infrastructure.dataobject.StockedCommodityDo;
import com.lvdapiaoliang.trade.infrastructure.mapper.OrderMapper;
      ...
      return Order.Builder()
          ...
          .commodities(Arrays.stream(commodityDos).map(
              d -> new StockedCommodity(d.getCommodityId(),
                  ...
                  d.getImageUrl(),
                  d.getPrice(),
                  d.getCount())).collect(Collectors.toList()))
...
//    @Pointcut("execution(* com.lvdapiaoliang.trade.domain.Order.cancel(..)) "
//        + "|| execution(* com.lvdapiaoliang.trade.domain.Order.succeed(..)) "
//        + "|| execution(* com.lvdapiaoliang.trade.domain.Order.setPaymentId(..))")
