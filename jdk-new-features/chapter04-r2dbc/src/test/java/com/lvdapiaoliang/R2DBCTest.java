...
import com.lvdapiaoliang.entity.TAuthor;
import com.lvdapiaoliang.entity.TBook;
import com.lvdapiaoliang.repositories.AuthorRepositories;
import com.lvdapiaoliang.repositories.BookAuthorRepostory;
import com.lvdapiaoliang.repositories.BookRepostory;
...
public class R2DBCTest {
  ...
  R2dbcEntityTemplate r2dbcEntityTemplate;
      //CRUD API； 更多API操作示例： https://docs.spring.io/spring-data/relational/reference/r2dbc/entity-persistence.html


  //贴近底层，join操作好做； 复杂查询好用
  //数据库客户端
  @Autowired
  ...
  void book() throws IOException {
    ...
    System.out.println(
        "bookAuthorRepostory.hahaBook(1L).block() = " + bookAuthorRepostory.hahaBook(1L)
            .block());
    //1-1：第二种方式
...
//        .bind(0,2L)
  ...
  void connection() throws IOException {
    ...
    // r2dbc基于全异步、响应式、消息驱动
    // jdbc:mysql://localhost:3306/farewell996
    // r2dbc:mysql://localhost:3306/farewell996
